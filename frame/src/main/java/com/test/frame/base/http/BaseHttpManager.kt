package com.test.frame.base.http

import android.util.Log
import com.jakewharton.retrofit2.adapter.kotlin.coroutines.CoroutineCallAdapterFactory
import com.test.frame.base.http.config.DEFAULT_LOGGER_TAG
import com.test.frame.base.http.config.DEFAULT_SUCCESS_CODE
import com.test.frame.base.http.config.DEFAULT_TIMEOUT
import com.test.frame.base.http.response.ApiResponse
...
import com.test.frame.base.http.handle.Result

abstract class BaseHttpManager {
    private var baseUrl = ""
    private var encryptionKey = ""
    private var encryptionStr = ""
    ...
    fun setEncryptionKey(encryption: String) {
        encryptionKey = Objects.requireNonNull(encryption, "encryptionKey == null")
    }

    fun setEncryptionHeader(encryption: String) {
        encryptionStr = Objects.requireNonNull(encryption, "encryptionKey == null")
    }
    ...
    suspend fun <T> requestFormat(deferred: Deferred<Response<ApiResponse<T>>>): Result<T> =
        requestFormatWithLoading(deferred) {}
